...
public class OrderMgrController {
    ...
    public ResponseEntity<PageInfo> listAll(@RequestParam(defaultValue = "1") Integer pageNum) throws Exception {
    ...
    public ResponseEntity<String> batchDeleteOrder(@RequestBody OrderForm orderForm) throws Exception {
