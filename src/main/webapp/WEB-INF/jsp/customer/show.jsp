        ...
        <form name="f2" method="POST" action="order/go" onSubmit="return checknum()">
            <table border="0" align="center" width="500px">
                <tr>
                    ...
                    <td><a href="${orders.pageNum>=orders.pages?orders.pages:orders.pageNum+1}">下一页</a></td>
                    <td><a href="${orders.pages}">最后一页</a></td>
                    <td>转到第:<input id="pages" type="text" name="pages" size="5">页<input type="submit" value="GO" name="cndok"></td>
                </tr>
            </table>
        </form>
    </div>
...
<script >
    ...
    function updateBtn(id){
        window.open("order/update?orderId="+id, "newwindow", "height=500, width=800, top=200, left=400, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no")
    }
